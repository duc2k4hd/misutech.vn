...
@php
    ...
    $rawDesc = $product->meta_description ?? ($product->short_description ?? Str::limit(strip_tags($product->content ?? ''), 160));
    ...
    // Giá
    $effectivePrice = (float)($product->sale_price && $product->sale_price < $product->price && $product->price > 0 ? $product->sale_price : $product->price);
    if ($effectivePrice <= 0) {
    ...
    $schemaProductGraph = [
        ...
        "@graph" => [
            ...
            [
                ...
                "releaseDate" => $product->published_at ? $product->published_at->format('Y-m-d') : now()->format('Y-m-d'),
                "offers" => [
                    "@type" => "Offer",
                    "url" => $productUrl,
                    "priceCurrency" => "VND",
...
@push('meta')
    ...
    <meta http-equiv="date" content="{{ $product->published_at ? $product->published_at->format('d/m/y') : now()->format('d/m/y') }}">
...
@push('styles')
    <link rel="stylesheet" href="{{ asset('clients/css/product.css') }}?v={{ file_exists(public_path('clients/css/product.css')) ? filemtime(public_path('clients/css/product.css')) : time() }}">
    <style>
...
@push('scripts')
    <script src="{{ asset('clients/js/product.js') }}?v={{ file_exists(public_path('clients/js/product.js')) ? filemtime(public_path('clients/js/product.js')) : time() }}"></script>
@endpush
...
@section('content')
        ...
        <nav class="misutech_product_breadcrumb" aria-label="Breadcrumb">
            <div class="misutech_product_container misutech_product_breadcrumb_inner">
                ...
                @if($product->category)
                    ...
                    <a class="misutech_product_breadcrumb_link" href="{{ route('categories.show', $product->category->slug) }}">
                        {{ $product->category->name }}
                    </a>
                @endif
                <span class="misutech_product_breadcrumb_separator">◆</span>
            ...
            <div class="misutech_product_container misutech_product_product_grid">
                ...
                <div class="misutech_product_gallery">
                    ...
                    <button class="misutech_product_main_image_button" type="button" data-open-image
                        ...
                        <img class="misutech_product_main_image"
                            id="misutech_main_img"
                    ...
                    <div class="misutech_product_thumbnails" id="misutech_product_thumbnails_wrapper" role="list" aria-label="Ảnh sản phẩm">
                    ...
                    <div class="misutech_product_direction" aria-label="Điều hướng sản phẩm">
                        <button class="misutech_product_direction_button" type="button" data-image-direction="-1" aria-label="Ảnh trước">‹</button>
                        <button class="misutech_product_direction_button" type="button" aria-label="Tất cả ảnh">⊞</button>
                        <button class="misutech_product_direction_button" type="button" data-image-direction="1" aria-label="Ảnh tiếp theo">›</button>
                    </div>
                    ...
                    <div class="misutech_product_share">
                        ...
                        <div class="misutech_product_share_list">
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->fullUrl()) }}"
                               ...
                               class="misutech_product_share_btn misutech_product_share_fb"
                               title="Chia sẻ lên Facebook" aria-label="Facebook">
                            ...
                            <a href="https://www.facebook.com/dialog/send?link={{ urlencode(request()->fullUrl()) }}&app_id=291494419107518&redirect_uri={{ urlencode(request()->fullUrl()) }}"
                               ...
                               title="Gửi qua Messenger" aria-label="Messenger">
                                <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor">
                                    <path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.615 4.469 8.654V24l4.088-2.245c1.093.303 2.248.467 3.443.467 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.192 14.963l-3.056-3.26-5.963 3.26 6.559-6.963 3.13 3.26 5.889-3.26-6.559 6.963z"/>
                                </svg>
                            </a>
                            ...
                            <button type="button" class="misutech_product_share_btn misutech_product_share_copylink"
                                    id="misutech_share_copy_btn"
                                    title="Sao chép liên kết" aria-label="Sao chép liên kết">
                ...
                <article class="misutech_product_product_info">
                    ...
                    <div class="misutech_product_rating_row">
                        ...
                        <span class="misutech_product_review_count">({{ number_format($product->reviews_count) }} đánh giá)</span>
                        @if($product->reviews_count > 0)
                            <a class="misutech_product_view_reviews" href="#misutech_product_reviews">XEM TẤT CẢ ĐÁNH GIÁ</a>
                        @endif
                    </div>
                    ...
                    <div class="misutech_product_price" id="misutech_product_price_box">
                        @if($product->sale_price && $product->sale_price < $product->price)
                            <span class="misutech_product_price_sale">{{ number_format($product->sale_price, 0, ',', '.') }}đ</span>
                            <span class="misutech_product_price_original">{{ number_format($product->price, 0, ',', '.') }}đ</span>
                        ...
                        @else
                            <span class="misutech_product_price_sale">{{ number_format($product->price, 0, ',', '.') }}đ</span>
                        @endif
                    </div>
                        ...
                        <div class="misutech_product_series_box">
                            <div class="misutech_product_series_header">
                                <span class="misutech_product_series_title">
                                    Dòng sản phẩm: <a href="{{ route('series.show', $product->series->slug) }}" style="color: #003b70; text-decoration: none; font-weight: 700;" title="Xem toàn bộ dòng {{ $product->series->name }}">{{ $product->series->name }} ↗</a>
                                </span>
                                <span class="misutech_product_series_badge">{{ $seriesProducts->count() }} model</span>
                            </div>
                            <div class="misutech_product_series_models" role="group" aria-label="Danh sách model thuộc dòng {{ $product->series->name }}">
                    ...
                    <dl class="misutech_product_meta">
                        <div class="misutech_product_meta_row">
                            ...
                            <dd id="misutech_product_stock_wrapper">
                                <span class="misutech_product_stock_dot {{ $product->status === 'active' ? '' : 'misutech_product_out_of_stock' }}" id="misutech_product_stock_dot"></span>
                                <span id="misutech_product_stock_text">{{ $product->status === 'active' ? 'Còn hàng' : 'Hết hàng' }}</span>
                            </dd>
                        </div>
                        <div class="misutech_product_meta_row" id="misutech_sku_row" style="{{ $product->sku ? '' : 'display:none;' }}">
                            <dt>Mã SP:</dt>
                    ...
                    <div class="misutech_product_extra_actions">
                        <button class="misutech_product_extra_button" type="button" data-open-modal="share"><span>↗</span> CHIA SẺ</button>
                        <button class="misutech_product_extra_button" type="button" data-open-modal="question"><span>◉</span> ĐẶT CÂU HỎI</button>
                        <button class="misutech_product_extra_button" type="button" data-open-modal="faq"><span>▣</span> FAQ</button>
                    </div>
                    ...
                    <div class="misutech_product_shipping_notes">
                        ...
                        <p><span class="misutech_product_shipping_icon">◉</span> Tư vấn hỗ trợ giờ hành chính các ngày trong tuần, nghỉ Chủ Nhật.</p>
                    </div>
                </article>
            </div>
        </section>
            ...
            <div class="misutech_product_container misutech_product_tabs_layout">
                ...
                <div class="misutech_product_tabs_main">
                    <div class="misutech_product_tabs" role="tablist" aria-label="Thông tin sản phẩm">
                        <button class="misutech_product_tab_button misutech_product_active" type="button" role="tab" aria-selected="true" data-tab="description">Mô tả sản phẩm</button>
                        <button class="misutech_product_tab_button" type="button" role="tab" aria-selected="false" data-tab="document">Tài liệu &amp; Catalog</button>
                        <button class="misutech_product_tab_button misutech_product_hide_on_mobile" type="button" role="tab" aria-selected="false" data-tab="delivery">Chính sách giao hàng</button>
                        <button class="misutech_product_tab_button misutech_product_hide_on_mobile" type="button" role="tab" aria-selected="false" data-tab="returns">Đổi trả &amp; Bảo hành</button>
                    </div>
                    <div class="misutech_product_tab_panels">
                        <div class="misutech_product_tab_panel misutech_product_active" id="misutech_tab_panel_description" role="tabpanel" data-panel="description">
                            @if($product->content)
                        ...
                        <div class="misutech_product_tab_panel" id="misutech_tab_panel_document" role="tabpanel" data-panel="document" hidden>
                                        ...
                                        <div class="misutech_product_catalog_item">
                                            <div class="misutech_product_catalog_header">
                                                ...
                                                <div class="misutech_product_catalog_actions">
                                                    ...
                                                    <a href="{{ route('documents.download', $doc->id) }}" class="misutech_product_catalog_btn misutech_product_catalog_btn_primary">
                                                        Tải xuống ⤓
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="misutech_product_catalog_frame_wrap">
                                                <iframe src="{{ $doc->url }}#navpanes=0&pagemode=none&view=FitH&toolbar=1" 
                        ...
                        <div class="misutech_product_tab_panel" role="tabpanel" data-panel="delivery" hidden>
                            <div class="misutech_product_policy_box">
                                ...
                                <ul class="misutech_product_policy_list">
                                    <li><strong>Nội thành Hải Phòng, Hà Nội, TP.HCM:</strong> Giao hàng hỏa tốc trong ngày (2 – 4 giờ).</li>
                                    <li><strong>Toàn quốc:</strong> Giao hàng từ 1 – 3 ngày làm việc qua Viettel Post / Chành xe uy tín.</li>
                                    <li><strong>Đồng kiểm tra:</strong> Khách hàng được kiểm tra hàng hóa, quy cách đóng gói trước khi thanh toán.</li>
                                    <li><strong>Miễn phí vận chuyển:</strong> Áp dụng cho các đơn hàng dự án hoặc theo hợp đồng cung ứng.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="misutech_product_tab_panel" role="tabpanel" data-panel="returns" hidden>
                            <div class="misutech_product_policy_box">
                                <h3 class="misutech_product_policy_heading">Chính sách bảo hành &amp; Đổi trả chính hãng</h3>
                                <ul class="misutech_product_policy_list">
                                    <li><strong>Bảo hành chính hãng:</strong> 12 tháng theo đúng tiêu chuẩn của nhà sản xuất.</li>
                                    <li><strong>Đổi mới 1 - 1 trong 7 ngày:</strong> Đổi sản phẩm mới nếu phát sinh lỗi kỹ thuật từ nhà sản xuất.</li>
                                    <li><strong>Tư vấn kỹ thuật 24/7:</strong> Kỹ sư hỗ trợ đọc sơ đồ đấu nối, cài đặt thông số và xử lý sự cố.</li>
                                    <li><strong>Chứng nhận CO/CQ:</strong> Cam kết cung cấp đầy đủ chứng từ xuất xứ và chất lượng.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <aside class="misutech_product_tabs_sidebar">
                    ...
                    <div class="misutech_product_side_card misutech_product_side_support">
                        <div class="misutech_product_side_card_header">
                            ...
                            <div>
                                ...
                                <p class="misutech_product_side_subtitle">Tra cứu mã thay thế, chiết khấu dự án tốt nhất</p>
                            </div>
                        </div>
                        <div class="misutech_product_side_actions">
                            <a href="tel:{{ preg_replace('/[^0-9]/', '', $hotline) }}" class="misutech_product_side_btn misutech_product_side_btn_call">
                                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                                <span>Hotline: <strong>{{ $hotline }}</strong></span>
                            </a>
                            <a href="{{ $zaloUrl }}" target="_blank" rel="noopener" class="misutech_product_side_btn misutech_product_side_btn_zalo">
                                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.615 4.469 8.654V24l4.088-2.245c1.093.303 2.248.467 3.443.467 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.192 14.963l-3.056-3.26-5.963 3.26 6.559-6.963 3.13 3.26 5.889-3.26-6.559 6.963z"/></svg>
                                <span>Chat Zalo nhận báo giá 5 phút</span>
                            </a>
                            <button type="button" class="misutech_product_side_btn misutech_product_side_btn_quote" data-open-modal="question">
                    ...
                    @php
                        $suggestedProducts = $seriesProducts->isNotEmpty() ? $seriesProducts->take(4) : $relatedProducts->take(4);
                    @endphp
                        ...
                        <div class="misutech_product_side_card misutech_product_side_suggest">
                            ...
                            <div class="misutech_product_side_products">
                                @foreach($suggestedProducts as $sp)
                                    @php
                                        $spThumb = $sp->thumbnail_url ?? ($sp->thumbnailMedia->first()?->url ?? asset('storage/clients/imgs/products/no-image.png'));
                                    @endphp
                                    <a href="{{ route('product.show', $sp->slug) }}" class="misutech_product_side_pitem">
                                        <div class="misutech_product_side_pimg">
                                            <img src="{{ $spThumb }}" alt="{{ $sp->name }}" loading="lazy" decoding="async">
                                        </div>
                                        <div class="misutech_product_side_pinfo">
                                            <h4 class="misutech_product_side_pname" title="{{ $sp->name }}">{{ $sp->name }}</h4>
            ...
            <div class="misutech_product_container misutech_product_benefit_grid">
                <article class="misutech_product_benefit">
                    <div class="misutech_product_benefit_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M20,8H17V4H3C1.89,4 1,4.89 1,6V17H3A3,3 0 0,0 6,20A3,3 0 0,0 9,17H15A3,3 0 0,0 18,20A3,3 0 0,0 21,17H23V12L20,8M6,18.5C5.17,18.5 4.5,17.83 4.5,17C4.5,16.17 5.17,15.5 6,15.5C6.83,15.5 7.5,16.17 7.5,17C7.5,17.83 6.83,18.5 6,18.5M18,18.5C17.17,18.5 16.5,17.83 16.5,17C16.5,16.17 17.17,15.5 18,15.5C18.83,15.5 19.5,16.17 19.5,17C19.5,17.83 18.83,18.5 18,18.5M17,12V9.5H19.5L21.47,12H17Z" /></svg>
                    </div>
                    <div>
                        <h2 class="misutech_product_benefit_title">MIỄN PHÍ VẬN CHUYỂN</h2>
                        <p class="misutech_product_benefit_text">Miễn phí vận chuyển toàn quốc cho đơn hàng từ 500.000đ.</p>
                    </div>
                </article>
                <article class="misutech_product_benefit">
                    <div class="misutech_product_benefit_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M11,15H6L13,1V9H18L11,23V15Z" /></svg>
                    </div>
                    <div>
                        <h2 class="misutech_product_benefit_title">GIAO HÀNG NHANH CHÓNG</h2>
                        <p class="misutech_product_benefit_text">Kho hàng phân bổ toàn quốc, giao hàng nhanh chóng đến mọi tỉnh thành.</p>
                    </div>
                </article>
                <article class="misutech_product_benefit">
                    <div class="misutech_product_benefit_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>
                    </div>
                    <div>
                        <h2 class="misutech_product_benefit_title">ĐỔI TRẢ 30 NGÀY</h2>
                        <p class="misutech_product_benefit_text">Cam kết hoàn tiền hoặc đổi sản phẩm trong vòng 30 ngày nếu có lỗi từ nhà sản xuất.</p>
                    </div>
                </article>
            </div>
        </section>
                ...
                <div class="misutech_product_container">
                    ...
                    <div class="misutech_product_related_grid">
                        @foreach($relatedProducts as $related)
                            <article class="misutech_product_related_card" 
                                ...
                                <a href="{{ route('product.show', $related->slug) }}" class="misutech_product_related_link">
                                    <div class="misutech_product_related_media">
                                        ...
                                        <div class="misutech_product_card_actions">
                                            <button class="misutech_product_card_action" type="button"
                                                data-cart data-related-cart data-product-id="{{ $related->id }}"
                                                aria-label="Thêm vào giỏ">＋</button>
                                            <button class="misutech_product_card_action" type="button"
                                                data-quick-view aria-label="Xem nhanh">⌕</button>
                                            <button class="misutech_product_card_action" type="button"
                                                data-related-wishlist data-product-id="{{ $related->id }}"
                                                aria-label="Yêu thích">♡</button>
                                        </div>
                                    </div>
                                    <h3 class="misutech_product_related_name" title="{{ $related->name }}">{{ $related->name }}</h3>
                                    ...
                                    <strong class="misutech_product_related_price">
                                        @if($related->sale_price && $related->sale_price < $related->price)
                                            <span class="misutech_product_price_sale_tag">{{ number_format($related->sale_price, 0, ',', '.') }}đ</span>
                                        @else
        ...
        <section class="misutech_product_reviews" id="misutech_product_reviews">
            <div class="misutech_product_container">
                <div class="misutech_reviews_section_header">
                    ...
                    <p class="misutech_reviews_section_subtitle">Đánh giá và nhận xét chân thực từ người dùng đã trải nghiệm sản phẩm</p>
                </div>
                ...
                <div class="misutech_product_review_layout">
                    ...
                    <aside class="misutech_product_review_summary">
                        <div class="misutech_product_review_score_box">
                            <div class="misutech_product_score_big">
                                <span class="misutech_product_score_value" id="misutech_summary_score">{{ number_format($product->rating_average ?? 5.0, 1) }}</span>
                                <span class="misutech_product_score_star">★</span>
                            </div>
                            <div class="misutech_product_stars_visual">
                                @for($i = 1; $i <= 5; $i++)
                                    <span class="star-item {{ $i <= round($product->rating_average ?? 5.0) ? 'filled' : '' }}">★</span>
                                @endfor
                            </div>
                            <div class="misutech_product_score_count">
                                <span id="misutech_summary_count">{{ number_format($product->reviews_count) }}</span> lượt đánh giá
                            </div>
                        </div>
                        ...
                        <div class="misutech_product_review_bars">
                            @foreach([5,4,3,2,1] as $star)
                                ...
                                <div class="misutech_product_review_bar_row">
                                    <span class="bar_star_label">{{ $star }} <span class="star_icon">★</span></span>
                                    <div class="bar_track">
                    ...
                    <div class="misutech_product_review_content">
                        ...
                        <div class="misutech_product_review_form_card" id="misutech_review_form_wrapper">
                            <form class="misutech_product_review_form" id="misutech_review_form" action="{{ route('product.review.store', $product->slug) }}" method="POST">
                                @csrf
                                <input type="hidden" name="_review_time_token" value="{{ \Illuminate\Support\Facades\Crypt::encryptString((string) (time() - 4)) }}">
                                <input type="hidden" name="rating" id="misutech_selected_rating" value="5">

                                {{-- Honeypot chống bot --}}
                                <div style="display: none !important;">
                                    <input type="text" name="review_hp_url" value="" tabindex="-1" autocomplete="off">
                                </div>
                                ...
                                <div class="form_header">
                                    ...
                                    <div class="rating_picker">
                                        ...
                                        <div class="misutech_star_picker" id="misutech_star_picker" aria-label="Chọn số sao">
                                            <button type="button" class="star_btn active" data-star="1" title="1 sao - Rất tệ">★</button>
                                            <button type="button" class="star_btn active" data-star="2" title="2 sao - Tệ">★</button>
                                            <button type="button" class="star_btn active" data-star="3" title="3 sao - Bình thường">★</button>
                                            <button type="button" class="star_btn active" data-star="4" title="4 sao - Tốt">★</button>
                                            <button type="button" class="star_btn active" data-star="5" title="5 sao - Tuyệt vời">★</button>
                                        </div>
                                ...
                                <div class="form_grid_fields">
                                    <div class="field_group">
                                        ...
                                        <input class="misutech_product_review_input" type="text" name="author_name" placeholder="Ví dụ: Anh Tuấn (Kỹ sư điện)" required maxlength="80">
                                    </div>
                                    <div class="field_group">
                                        <label class="field_label">Số điện thoại / Zalo <span class="opt">(Bảo mật, không hiện công khai)</span></label>
                                        <input class="misutech_product_review_input" type="tel" name="author_phone" placeholder="Ví dụ: 0987654321" maxlength="20">
                                    </div>
                                </div>

                                <div class="field_group">
                                    <label class="field_label">Nội dung đánh giá &amp; Trải nghiệm thực tế <span class="req">*</span></label>
                                    <textarea class="misutech_product_review_textarea" name="comment" rows="4" placeholder="Chia sẻ cảm nhận về chất lượng thiết bị, độ chính xác, quy cách đóng gói, tiến độ giao hàng..." required minlength="5" maxlength="1000"></textarea>
                                </div>

                                <div class="review_form_error" id="misutech_review_error" style="display: none;"></div>

                                <div class="form_actions">
                                    <button class="misutech_product_review_submit" type="submit" id="misutech_review_submit_btn">
                        ...
                        <div class="misutech_reviews_list" id="misutech_reviews_list">
                            ...
                            @else
                                @foreach($product->reviews as $review)
                                    @php
                                        $author = $review->author_name ?: ($review->user?->name ?: 'Khách hàng Misutech');
                                    ...
                                    <article class="misutech_product_submitted_review">
                                        ...
                                        <div class="review_body">
                                            <div class="review_header">
                                                ...
                                                <span class="review_time">{{ $review->created_at ? $review->created_at->diffForHumans() : 'Gần đây' }}</span>
                                            </div>
                                            <div class="review_stars">
                                                @for($i = 1; $i <= 5; $i++)
                                                    <span class="star-item {{ $i <= $review->rating ? 'filled' : '' }}">★</span>
                                                @endfor
                                            </div>
    ...
    <aside class="misutech_product_cart_drawer" aria-hidden="true">
        <div class="misutech_product_cart_drawer_header"><h2 class="misutech_product_cart_drawer_title">Giỏ hàng</h2><button class="misutech_product_cart_close" type="button" aria-label="Close cart">×</button></div>
        <div class="misutech_product_cart_items"><p class="misutech_product_cart_empty">Giỏ hàng của bạn đang trống.</p></div>
        <div class="misutech_product_cart_footer"><span>Tổng cộng</span><strong class="misutech_product_cart_total">0đ</strong></div>
    </aside>
    <div class="misutech_product_drawer_overlay" hidden></div>

    <div class="misutech_product_modal" data-modal="image" hidden>
        <div class="misutech_product_modal_dialog misutech_product_image_dialog" role="dialog" aria-modal="true" aria-label="Ảnh sản phẩm">
            <button class="misutech_product_modal_close" type="button" data-close-modal aria-label="Đóng">×</button>
            <img class="misutech_product_modal_image" src="{{ $product->thumbnailMedia->first()?->url ?? asset('storage/clients/imgs/products/no-image.png') }}" alt="{{ $product->name }}">
        </div>
    </div>

    {{-- Modal Hỏi đáp & Báo giá --}}
    <div class="misutech_product_modal" data-modal="question" hidden>
        <div class="misutech_product_modal_dialog" role="dialog" aria-modal="true" aria-labelledby="misutech_product_question_title">
            <button class="misutech_product_modal_close" type="button" data-close-modal aria-label="Đóng">✕</button>
            <div class="misutech_modal_header">
                <div class="misutech_modal_icon">💬</div>
                <div>
                    <h3 class="misutech_product_modal_title" id="misutech_product_question_title">Tư vấn kỹ thuật &amp; Báo giá</h3>
                    <p class="misutech_product_modal_text">Đội ngũ kỹ sư MISUTECH sẽ phản hồi qua điện thoại / Zalo trong vòng 15 phút.</p>
                </div>
            </div>

            <div class="misutech_modal_product_preview">
                <img src="{{ $product->thumbnailMedia->first()?->url ?? asset('storage/clients/imgs/products/no-image.png') }}" alt="{{ $product->name }}">
            ...
            <form class="misutech_product_question_form" action="{{ route('contact.submit') }}" method="POST">
                @csrf
                <input type="hidden" name="subject" value="[Tư vấn SP] {{ $product->name }} (Mã: {{ $product->sku }})">
                <input type="hidden" name="_form_time_token" value="{{ \Illuminate\Support\Facades\Crypt::encryptString((string) (time() - 5)) }}">
                ...
                <div class="misutech_modal_form_grid">
                    <div class="misutech_modal_form_group">
                        ...
                        <input class="misutech_product_modal_input" type="text" name="fullname" placeholder="Ví dụ: Nguyễn Văn A" required>
                    </div>
                    <div class="misutech_modal_form_group">
                        <label class="misutech_modal_label">Số điện thoại / Zalo <span class="required">*</span></label>
                        <input class="misutech_product_modal_input" type="tel" name="phone" placeholder="Ví dụ: 0912345678" required>
                    </div>
                </div>

                <div class="misutech_modal_form_group">
                    <label class="misutech_modal_label">Email nhận báo giá (Tùy chọn)</label>
                    <input class="misutech_product_modal_input" type="email" name="email" placeholder="example@company.com">
                </div>

                <div class="misutech_modal_form_group">
                    <label class="misutech_modal_label">Nội dung câu hỏi / Số lượng cần mua <span class="required">*</span></label>
                    <textarea class="misutech_product_modal_textarea" name="message" rows="3" placeholder="Ví dụ: Tôi cần tư vấn thông số kỹ thuật và báo giá cho 10 sản phẩm..." required></textarea>
                </div>

                <div class="misutech_modal_error_msg" style="display: none; color: #dc2626; font-size: 12.5px; margin-bottom: 10px;"></div>
    ...
    <div class="misutech_product_modal" data-modal="faq" hidden>
        <div class="misutech_product_modal_dialog" role="dialog" aria-modal="true" aria-labelledby="misutech_product_faq_title">
            <button class="misutech_product_modal_close" type="button" data-close-modal aria-label="Đóng">✕</button>
            <div class="misutech_modal_header">
                <div class="misutech_modal_icon">▣</div>
                <div>
            ...
            <div class="misutech_product_faq_list">
                <details class="misutech_product_faq_item" open>
                    ...
                    <p>Có. 100% sản phẩm do MISUTECH cung cấp đều là hàng chính hãng từ nhà sản xuất, có đầy đủ chứng nhận xuất xứ (CO), chứng nhận chất lượng (CQ) và hóa đơn VAT hợp lệ.</p>
                </details>
                <details class="misutech_product_faq_item">
                    <summary>2. Thời gian giao hàng bao lâu?</summary>
                    <p>Nội thành Hải Phòng, Hà Nội, TP.HCM giao hỏa tốc trong 2 – 4 giờ. Các tỉnh thành khác giao từ 1 – 3 ngày làm việc qua chuyển phát nhanh hoặc chành xe theo yêu cầu.</p>
                </details>
                <details class="misutech_product_faq_item">
                    <summary>3. Chính sách bảo hành và đổi trả như thế nào?</summary>
                    <p>Sản phẩm được bảo hành chính hãng 12 tháng. Đổi mới 1 - 1 trong vòng 7 ngày đầu nếu phát sinh lỗi kỹ thuật do nhà sản xuất.</p>
                </details>
                <details class="misutech_product_faq_item">
                    <summary>4. Có được hỗ trợ kỹ thuật cài đặt &amp; đấu nối không?</summary>
                    <p>Đội ngũ kỹ sư tự động hóa của MISUTECH sẵn sàng hỗ trợ tư vấn sơ đồ dây, cấu hình thông số và xử lý sự cố 24/7 qua Hotline / Zalo.</p>
                </details>
            </div>
        </div>
    </div>
    ...
    <div class="misutech_product_modal" data-modal="share" hidden>
        <div class="misutech_product_modal_dialog" role="dialog" aria-modal="true" aria-labelledby="misutech_product_share_title">
            <button class="misutech_product_modal_close" type="button" data-close-modal aria-label="Đóng">✕</button>
            <div class="misutech_modal_header">
                <div class="misutech_modal_icon">↗</div>
                <div>
    ...
    <div class="misutech_product_modal" data-modal="quick" hidden>
        <div class="misutech_product_modal_dialog misutech_product_quick_dialog" role="dialog" aria-modal="true" aria-labelledby="misutech_product_quick_title">
            <button class="misutech_product_modal_close" type="button" data-close-modal aria-label="Đóng">✕</button>
            ...
            <div>
                ...
                <button class="misutech_product_modal_submit misutech_product_quick_add" type="button">THÊM VÀO GIỎ HÀNG</button>
            </div>
        </div>
    </div>
